...
namespace StarForce
{
    public class MyAircraft : Aircraft
    {
...
#endif
        {
            ...
            GameEntry.Event.Fire(this, LifeFormChangedEventArgs.Create(GetLifeCount()));
        }
...
#endif
        {
            ...
            Vector3 speed = Vector3.ClampMagnitude(direction.normalized * (m_MyAircraftData.Speed + m_SpeedBoost) * elapseSeconds, direction.magnitude);
        ...
        protected override void OnDead(Entity attacker) {
            ...
            m_MyAircraftData.LifeCount--;

            if (GetLifeCount() > 0) {
                m_MyAircraftData.HP = m_MyAircraftData.MaxHP;
                m_MyAircraftData.Position = Vector3.zero;
                m_TargetPosition = Vector3.zero;
                GameEntry.Entity.ShowMyAircraft(m_MyAircraftData);
        ...
        public int GetLifeCount() {
            return m_MyAircraftData.LifeCount;
        }
