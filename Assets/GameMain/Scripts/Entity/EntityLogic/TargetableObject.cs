...
namespace StarForce
{
    ...
    public abstract class TargetableObject : Entity
    {
        ...
        public void ApplyHeal(int healHP) {
            float fromHPRatio = m_TargetableObjectData.HPRatio;
            m_TargetableObjectData.HP = Mathf.Min(m_TargetableObjectData.MaxHP, m_TargetableObjectData.HP + healHP);
            float toHPRatio = m_TargetableObjectData.HPRatio;
            if (fromHPRatio < toHPRatio) {
                GameEntry.HPBar.ShowHPBar(this, fromHPRatio, toHPRatio);
            }
        ...
        private void OnTriggerEnter(Collider other)
        {
            ...
            if (GameEntry.Entity.GetEntity(entity.Id) && GameEntry.Entity.GetEntity(Id)) {
                AIUtility.PerformCollision(this, entity);
            }
        }

        public int GetHP() {
            return m_TargetableObjectData.HP;
        }
    }
}
