...
namespace StarForce
{
    public static class EntityExtension
    {
        ...
        public static void ShowDrop(this EntityComponent entityCompoennt, Type logicType, DropData data) {
            entityCompoennt.ShowEntity(logicType, "Drop", Constant.AssetPriority.DropAsset, data);
        }
